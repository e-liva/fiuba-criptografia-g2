...
ckd_style('apple-keyboard-white','keyboard-type');
...
$(function(){
	...
	$("#ktype").iButton({
		...
		change:function($el){
			if($el.attr("checked")){
				$('#keyboard-type').attr('href',"css/apple-keyboard-white.css");
			} else {
				$('#keyboard-type').attr('href',"css/apple-keyboard-black.css");
			}
		}
	});
	...
	function spec(code,loc,pressure) {
		keyEvent('.c'+code+'.k'+(loc==2?'r':'l'),pressure);
	}
		...
		<ul class="cf" id="bottomrow">
            ...
            <ol class="cf">
            	...
            	<li><a href="#" class="key c39" id="right"><span><img src="right.png" /></span></a></li>
					...
					<input type='checkbox' value='ktype' id='ktype'>
