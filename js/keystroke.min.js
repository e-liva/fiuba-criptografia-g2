...
this.a;this.a={}};this.load=function(a){this.a=this.profiles[a];void 0==this.a&&(this.a={})};this.run=function(a){if("train"==s())a("Entrenando... Haga click en modo <span class='label label-info'>RUN</span> para probar");else if(this.a){var c=y(f.data,f.a);a(void 0==c?"No se entrenó lo suficiente":"Resultado: "+x(c));this.data={}}else a("Please train first");w()};this.match=function(a){if("train"==s())a("Entrenando... Haga click en modo <span class='label label-info'>RUN</span> para probar");else{var c=null,b=200,d;for(d in this.profiles){var f=
